...
typedef std::set<long> Sset;


extern std::map<struct fp_node *, Sset> R_Map;
extern std::map<long long, int>globle_failed_blks;
extern long long globle_failed_blks_count;
...
extern long long end_recon_point; //it is the ending plk of the recovering stripe.
