...
//	trace = 0;
    ...
    Argv_Parse(7, default_setting, file_prefix, file_suffix);
...
//	C_Policy = atoi(argv[9]);
    ...
    cout << "P_Policy is: " << Policy << " C_policy= "<< cache_policy << "  degraded is: " << degraded << "  IO queues are:  "<< QUEUE_NUM <<endl;
    ...
    for(int i = 0; i < cache_policy; i++)
    {
    	...
    	globle_failed_blks.clear();
    	globle_failed_blks_count = 0;
